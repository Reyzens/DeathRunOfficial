...
public class TrapList : NetworkBehaviour
{
    [SerializeField]
    ...
    [SerializeField]
    private float m_platformAccelerationCooldown = 7.0f;
    [SerializeField]
    private float m_platformReverseCooldown = 7.0f;


    [SerializeField]
    public List<FlamethrowerActivation> m_flamethrowerSerieOne = new List<FlamethrowerActivation>();
    [SerializeField]
    public List<FlamethrowerActivation> m_flamethrowerSerieTwo = new List<FlamethrowerActivation>();
    [SerializeField]
    public List<FlamethrowerActivation> m_flamethrowerSerieThree = new List<FlamethrowerActivation>();
    [SerializeField]
    public List<FlamethrowerActivation> m_flamethrowerSerieFour = new List<FlamethrowerActivation>();
    [SerializeField]
    public List<FlamethrowerActivation> m_flamethrowerSerieFive = new List<FlamethrowerActivation>();
    [SerializeField]
    public TrapDoorController m_trapDoorOne;
    [SerializeField]
    public TrapDoorController m_trapDoorTwo;
    [SerializeField]
    public TrapDoorController m_trapDoorThree;
    [SerializeField]
    public TrapDoorController m_trapDoorFour;
    [SerializeField]
    public TrapDoorController m_trapDoorFive;
    [SerializeField]
    public TrapDoorController m_trapDoorSix;
    [SerializeField]
    public TrapDoorController m_trapDoorSeven;
    [SerializeField]
    public TrapDoorController m_trapDoorEigth;
    [SerializeField]
    public List<MovingPlatform> m_movingPlatformSerieOne = new List<MovingPlatform>();
    ...
    public void InverseMovingPlatform()
    {
        ...
        {
            Debug.Log("Calling reversing of platform");
    ...
    public void AccelerateMovingPlatform()
    {
        ...
        {
            Debug.Log("Calling Acceleration of platform");
            foreach (MovingPlatform movingPlatform in m_movingPlatformSerieOne)
            {
